...
@description('Name of the Budget should be unique within a resource group.')
param budgetName string = 'DemoBudget'

@description('The total amount of cost you need to track with the budget')
